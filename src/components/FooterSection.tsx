...
import { Github, Twitter, Linkedin, ChevronDown, Star } from 'lucide-react';
...
const FooterSection = () => {
  ...
  return (
    <footer className="relative">
      {/* Community Highlight Band */}
      <div className="relative overflow-hidden">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10" />
        <div className="absolute inset-0 bg-background/80" />
        
        <div className="relative max-w-[1280px] mx-auto px-6 md:px-12 py-10">
          <motion.div
          ...
          >
            <p className="font-display text-xl sm:text-2xl text-foreground">
              Join <span className="text-primary">1,000+</span> builders in the deKAOS community.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <Button
                variant="outline"
                className="gap-2 border-white/20 bg-white/5 text-foreground hover:bg-white/10 hover:border-white/30"
                asChild
              >
              ...
              <Button
                ...
                asChild
              >
                <a href="https://github.com/dekaos/dekaos" target="_blank" rel="noopener noreferrer">
      ...
      {/* Main Footer */}
      <div className="bg-[hsl(222_47%_6%)] border-t border-primary/20">
